...
import 'package:latihan_api_bloc/data/response/game_response.dart';
...
class GameCreateBloc extends Bloc<GameCreateEvent, GameCreateState> {
  ...
  void _onGameCreatePressed(
      GameCreatePressed event, Emitter<GameCreateState> emit) {
    final gameParam = GameParam(name: event.gameParam.name, price: event.gameParam.price, status: event.gameParam.status);
